          ...
          {socials.map((social, index) => (
            ...
            >
              ...
              <Link
                href={social.link}
                target="_blank"
                className="relative block dark:bg-zinc-900/50 bg-white backdrop-blur-sm border dark:border-white/10 border-gray-200/50 rounded-2xl p-6 hover:border-p_green/30 transition-all duration-500 group shadow-lg dark:shadow-none"
              >
